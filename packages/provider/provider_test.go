...
// TestOpenCodeGoCatalog pins the Grok 4.5 entry added to the OpenCode Go
// provider. It is listed in the vendor's current Go model lineup
// (https://opencode.ai/docs/go) and was missing from the baked-in catalog.
